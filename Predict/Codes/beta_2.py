...
if __name__ == '__main__':
    ...
    for factor in factors:
        ...
        r_hat = r_hat.add(factor_df.mul(beta_neg_mean_hat.loc[:, factor], 0), fill_value=0)
        r_hat = r_hat.add(pos_mask * factor_df.sub(knot_1, 0).mul(beta_pos_mean_hat.loc[:, factor] - beta_neg_mean_hat.loc[:, factor], 0), fill_value=0)
